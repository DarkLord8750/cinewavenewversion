    ...
    <div className="min-h-screen bg-black text-white">
      <div className="relative min-h-[65vh] sm:min-h-[80vh] flex flex-col">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://source.unsplash.com/featured/?movie,cinema" 
          ...
          <div className="space-y-2 mb-12">
            {[
              ...
              },
              {
                ...
                answer: "Watch anywhere, anytime. Sign in with your Netflix account to watch instantly on the web from your personal computer or on any internet-connected device that offers the Netflix app."
              },
              {
      ...
      <footer className="py-16 border-t-8 border-gray-800 text-gray-400">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="mt-10">
            ...
            <p className="mt-6">Netflix Clone</p>
          </div>
        </div>
      </footer>
    </div>
