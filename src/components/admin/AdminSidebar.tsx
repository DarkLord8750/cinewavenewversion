...
import { LayoutDashboard, Film, Users, Settings, BarChart, LogOut } from 'lucide-react';
...
const AdminSidebar = () => {
  ...
  return (
    <aside className="w-64 bg-netflix-dark h-screen flex flex-col shadow-lg sticky top-0">
