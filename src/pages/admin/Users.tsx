  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-600">Manage users and their access to your Netflix platform.</p>
      </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-netflix-red focus:border-transparent text-gray-900"
              />
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleUpdateUser} className="space-y-6">
                ...
                <div className="mt-2 space-y-2">
                  <div className="flex items-center">
                    <input
                      ...
                      className="h-4 w-4 text-netflix-red focus:ring-netflix-red border-gray-300"
                    />
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-netflix-red focus:border-netflix-red sm:text-sm rounded-md text-gray-900"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-netflix-red focus:border-netflix-red sm:text-sm text-gray-900"
