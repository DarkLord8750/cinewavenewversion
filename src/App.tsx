...
function App() {
  ...
  useEffect(() => {
    if (!isAuthenticated && 
      ...
      navigate('/login');
    } else if (isAuthenticated && user?.email === 'uveshmalik.8860@gmail.com' && location.pathname === '/browse') {
      // Redirect admin to admin dashboard from browse page
      navigate('/admin');
    } else if (isAuthenticated && user?.email !== 'uveshmalik.8860@gmail.com' && location.pathname.includes('/admin')) {
