...
const ContentCard = ({ content, onPlay }: ContentCardProps) => {
  ...
  const watchProgress = currentProfile
  ...
  return (
    <div
      className="block relative w-[200px] group cursor-pointer"
      ...
      <div className="relative h-[280px] rounded-lg overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black via-black/80 to-transparent">
          <div className="space-y-2">
            <h3 className="font-medium text-white text-base line-clamp-1">{content.title}</h3>
            
            <div className="flex items-center gap-2 text-sm">
              <span className="text-green-500 font-medium">98% Match</span>
              <span className="text-white/70 px-1.5 py-0.5 border border-white/30">
        ...
        {isHovered && (
          <div className="absolute inset-0 bg-black/20 flex items-end p-4 z-20">
